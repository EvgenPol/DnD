...
extension OtherItems {
    var rawValue: (name:String, cost:Double, weight:Double) {
        ...
        case .acidVial: return ("Кислота", 25_00, 1)
        case .alchemistsFireFlask: return ("Алхемический огонь", 50_00, 1)
        case .antitoxinVial: return ("Противоядие",50_00, 0.1)
        case .backpack: return ("Рюкзак", 2_00, 5)
        case .ballBearings: return ("Шарики(1000 в сумке)", 1_00, 2)
        case .barrel: return ("Бочка", 2_00, 70)
        case .basket: return ("Корзина", 4_0, 2)
        case .bedroll: return ("Постельные принадлежности", 1_00, 7)
        case .bell: return ("Колокольчик", 1_00, 0.1)
        case .blanket: return ("Одеяло", 5_0, 3)
        case .blockAndTackle: return ("Грузоподъемный блок", 1_00, 5)
        case .book: return ("Книга", 25_00, 5)
        ...
        case .caseCrossbowBolt: return ("Футляр для арбалетных болтов", 1_00, 1)
        case .caseMapOrScroll: return ("Футляр для карт или свитков", 1_00, 1)
        case .chain: return ("Цепь (10 футов)", 5_00, 10)
        case .chalk: return ("Пергамент (один лист)", 1, 0.1)
        case .chest: return ("Сундук", 5_00, 25)
        case .climbersKit: return ("Набор скалолаза", 25_00, 12)
        case .clothesCommon: return ("Обычная одежда", 5_00, 3)
        case .clothesCostume: return ("Официальная одежда", 5_00, 4)
        case .clothesFine: return ("Качественная одежда", 15_00, 6)
        case .clothesTraveler: return ("Одежда путешественника", 2_00, 4)
        case .componentPouch: return ("Мешочек для компонентов", 25_00, 12)
        case .crowbar: return ("Монтировка", 2_00, 5)
        case .fishingTackle: return ("Рыболовные снасти", 1_00, 4)
        case .flaskOfTankard: return ("Столовые приборы", 2, 1)
        case .glass: return ("Стакан", 2_00, 2)
        case .grapplingHook: return ("Крюк-кошка", 2_00, 4)
        case .hammer: return ("Молоток", 1_00, 3)
        case .hammerSledge: return ("Кувалда", 2_00, 10)
        case .healersKit: return ("Набор лекаря", 5_00, 3)
        case . : return ("", ,)
        case . : return ("", ,)
        case . : return ("", ,)
        case . : return ("", ,)
